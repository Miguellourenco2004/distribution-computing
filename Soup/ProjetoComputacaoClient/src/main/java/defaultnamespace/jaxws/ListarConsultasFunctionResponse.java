...
@XmlRootElement(name = "listarConsultasFunctionResponse", namespace = "http://default_package/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "listarConsultasFunctionResponse", namespace = "http://default_package/")

public class ListarConsultasFunctionResponse {
