...
@XmlRootElement(name = "listarClinicasFunctionResponse", namespace = "http://default_package/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "listarClinicasFunctionResponse", namespace = "http://default_package/")

public class ListarClinicasFunctionResponse {
