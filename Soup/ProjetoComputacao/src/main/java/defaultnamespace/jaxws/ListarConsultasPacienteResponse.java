...
@XmlRootElement(name = "listarConsultasPacienteResponse", namespace = "http://default_package/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "listarConsultasPacienteResponse", namespace = "http://default_package/")
